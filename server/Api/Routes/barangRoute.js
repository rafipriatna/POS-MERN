...
router.post('/kategori/', checkAuth.adminAuth, barangController.createKategoriBarang)
router.get('/kategori/', checkAuth.adminAuth, barangController.getAllKategoriBarang)
router.get('/kategori/:id', checkAuth.adminAuth, barangController.getKategoriBarangById)
router.patch('/kategori/:id', checkAuth.adminAuth, barangController.updateKategoriBarang)
router.delete('/kategori/:id', checkAuth.adminAuth, barangController.deleteKategoriBarang)
